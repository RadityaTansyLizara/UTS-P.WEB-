...
<head>
    ...
    <title>Profil - Raditya Tansy Lizara</title>
    <style>
...
<body>
    ...
    <div class="profile-container">
        <!-- Foto Profil -->
        <img src="image/F. TYA.jpeg" class="profile-img"
            alt="Foto Raditya Tansy Lizara">

        <!-- Nama dan Universitas -->
        <h2 class="profile-name">Raditya Tansy Lizara</h2>
        <p class="profile-university">Jl. Contoh, Kota Contoh</p>
    </div>
    <div id="carouselExampleCaptions" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="image/SMA.jpeg" class="d-block w-100" alt="...">
